...
import { 
  GraduationCap, Menu, X, Clock, Award, Target, CheckCircle, 
  BookOpen, Users, Calendar, MapPin, Phone, Mail, ArrowRight,
  Download, ExternalLink, Star, Globe, TrendingUp, Zap
} from 'lucide-react';
  ...
  const quarters = [
      ...
      courses: [
        {
          ...
          duration: "12 weeks",
          prerequisites: "Bachelor's degree in life sciences or equivalent",
          assessments: ["Midterm Exam (25%)", "Final Project (35%)", "Lab Reports (25%)", "Participation (15%)"],
          textbooks: ["Molecular Biology of the Cell (Alberts et al.)", "Bioinformatics and Functional Genomics (Pevsner)"],
          software: ["NCBI Tools", "UniProt", "Ensembl", "UCSC Genome Browser"]
        },
        {
          code: "BCB102",
          credits: 3,
          ...
          assessments: ["Coding Projects (40%)", "Statistical Analysis Report (30%)", "Git Portfolio (20%)", "Peer Code Review (10%)"],
          textbooks: ["Python for Data Analysis (McKinney)", "R for Data Science (Wickham & Grolemund)"],
          software: ["Python", "R/RStudio", "Git/GitHub", "Jupyter Notebooks"]
        },
        {
          code: "BCB103",
          credits: 3,
          ...
          difficulty: "Beginner",
          duration: "12 weeks",
          prerequisites: "BCB101 (can be taken concurrently)",
    ...
    },
    {
      ...
      learningOutcomes: [
        ...
        "Understand protein structure prediction and analysis",
        "Apply population genetics analysis methods"
      ],
      courses: [
        {
          code: "BCB201",
          ...
          difficulty: "Advanced",
          duration: "12 weeks",
          prerequisites: "BCB101, BCB102",
          assessments: ["Pipeline Development Project (45%)", "Research Paper Analysis (25%)", "Lab Practicals (20%)", "Presentation (10%)"],
          textbooks: ["RNA-seq Data Analysis (Love et al.)", "Bioinformatics Algorithms (Compeau & Pevzner)"],
          software: ["FastQC", "STAR", "DESeq2", "EdgeR", "IGV", "Galaxy"]
        },
        {
          code: "BCB202",
          credits: 3,
    ...
    },
    {
      ...
      learningOutcomes: [
        ...
        "Utilize generative AI for drug discovery and design",
        "Understand ethical considerations in biomedical AI"
      ],
      courses: [
        {
          code: "BCB301",
          ...
          difficulty: "Advanced",
          duration: "12 weeks",
          prerequisites: "BCB102, BCB201",
          assessments: ["ML Project Portfolio (50%)", "Algorithm Implementation (25%)", "Ethics Report (15%)", "Peer Review (10%)"],
          textbooks: ["The Elements of Statistical Learning (Hastie et al.)", "Pattern Recognition in Bioinformatics (Baldi & Brunak)"],
          software: ["scikit-learn", "TensorFlow", "Keras", "pandas", "matplotlib", "seaborn"]
        },
        {
          code: "BCB302",
          credits: 3,
          ...
          difficulty: "Expert",
          duration: "12 weeks",
          prerequisites: "BCB301",
          assessments: ["Deep Learning Project (55%)", "Generative Model (25%)", "Research Proposal (15%)", "Code Documentation (5%)"],
          textbooks: ["Deep Learning (Goodfellow et al.)", "Generative AI for Drug Discovery (Smith et al.)"],
          software: ["PyTorch", "TensorFlow", "Hugging Face", "OpenAI API", "AlphaFold", "ChemBERTa"]
        },
        {
          code: "BCB303",
          credits: 3,
    ...
    },
    {
      ...
      totalCredits: 9,
      learningOutcomes: [
        "Conduct independent research with industry mentorship",
        "Develop professional communication and presentation skills",
        "Build a comprehensive portfolio for career readiness",
        "Establish professional networks in the biotech industry"
      ],
      courses: [
        {
          code: "BCB401",
          ...
          difficulty: "Expert",
          duration: "12 weeks",
          prerequisites: "All previous quarters",
          assessments: ["Research Project (60%)", "Final Thesis (25%)", "Oral Defense (10%)", "Peer Collaboration (5%)"],
          textbooks: ["Research project-specific literature", "The Craft of Research (Booth et al.)"],
          software: ["Project-dependent advanced tools", "LaTeX/Overleaf", "Presentation software"]
        },
        {
          code: "BCB402",
          credits: 3,
          ...
          assessments: ["Portfolio Development (40%)", "Grant Proposal (30%)", "Professional Presentation (20%)", "Industry Interview (10%)"],
          textbooks: ["Scientific Writing and Communication (Hofmann)", "The Biotech Career Guide (Shimasaki)"],
          software: ["Adobe Creative Suite", "R Shiny", "Tableau", "LinkedIn Learning", "Zoom"]
        }
      ]
    }
  ];
              ...
              {['Curriculum', 'Admissions', 'Faculty'].map((item, index) => (
                <motion.a
                  ...
                  className={`relative font-medium transition-colors duration-300 py-2 ${
                    item === 'Curriculum' ? 'text-blue-600' : 'text-gray-700 hover:text-blue-600'
                  }`}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Program Structure</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Four intensive quarters covering everything from molecular biology fundamentals 
              to cutting-edge AI applications in biotechnology.
            </p>
          </motion.div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white p-4 rounded-xl shadow-sm">
                      <div className="text-2xl font-bold text-blue-600">{quarters[activeTab].totalCredits}</div>
                      <div className="text-sm text-gray-600">Credits</div>
                    </div>
                    <div className="bg-white p-4 rounded-xl shadow-sm">
                      <div className="text-2xl font-bold text-green-600">{quarters[activeTab].duration}</div>
                      <div className="text-sm text-gray-600">Duration</div>
                    </div>
                  </div>
                </div>
                <div>
                  <h4 className="text-lg font-bold text-gray-900 mb-4">Learning Outcomes</h4>
                  <div className="space-y-3">
                    {quarters[activeTab].learningOutcomes.map((outcome, index) => (
                ...
                >
                  <div className="flex flex-col lg:flex-row gap-8">
                    <div className="lg:w-1/3 flex-shrink-0">
                      <div className="bg-gradient-to-br from-blue-600 to-purple-600 text-white px-6 py-4 rounded-2xl font-bold text-center mb-6">
                        {course.code}
                      </div>
                    ...
                    <div className="lg:w-2/3">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          <h5 className="font-semibold text-gray-900 mb-3">Assessment Methods</h5>
                        ...
                        <div>
                          <h5 className="font-semibold text-gray-900 mb-3">Software & Tools</h5>
                          <div className="flex flex-wrap gap-2">
                            {course.software.map((tool, idx) => (
                      ...
                      <div className="mt-6">
                        <h5 className="font-semibold text-gray-900 mb-3">Required Textbooks</h5>
                        <div className="space-y-2">
